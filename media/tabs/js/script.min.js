...
$('.nn_tabs-tab a[data-toggle="tab"]').on('show',function($e){window.location.hash=String($e.target).substr(String($e.target).indexOf("#")+1);$e.stopPropagation();});}});})(jQuery);